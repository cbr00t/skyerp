class Config extends CObject {
	...
	applyColorScheme(e) {
		let {colorScheme} = this; colorScheme = colorScheme?.char ?? colorScheme; colorScheme = colorScheme?.toLowerCase() || '';
		const cssClass = 'dark-theme'; switch (colorScheme) { case 'dark': $('body').addClass(cssClass); break; default: $('body').removeClass(cssClass); break }
	}
}
