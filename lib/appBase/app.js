class App extends AppBase {
	...
	*getModulIter() { const {moduller} = this; if (moduller) { for (const modul of Object.values(moduller)) { yield modul } } }
	...
	wsEMailGonder(e) {
		...
		return ajaxPost({ timeout: 60 * 1000, processData: false, ajaxContentType: wsContentTypeVeCharSet, url: app.getWSUrl({ session: null, wsPath: 'ws/eMail', api: 'send', args }), data })
	}
