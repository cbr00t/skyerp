class App extends AppBase {
    static { window[this.name] = this; this._key2Class[this.name] = this } get dbMgrClass() { return null } get offlineMode() { return this._offlineMode ?? config.offlineMode }
	...
	constructor(e) {
		...
		const {offlineMode, dbMgrClass} = this; if (offlineMode !== true && dbMgrClass) {
