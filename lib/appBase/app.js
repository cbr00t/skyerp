class App extends AppBase {
	...
	sqlTrnBegin(e) { e = e || {}; return ajaxPost({ timeout: 8000, processData: false, ajaxContentType: wsContentType, url: app.getWSUrl({ api: 'sqlTrnBegin', args: e }) }) }
	sqlTrnEnd(e) { e = e || {}; return ajaxPost({ timeout: 8000, processData: false, ajaxContentType: wsContentType, url: app.getWSUrl({ api: 'sqlTrnEnd', args: e }) }) }
	sqlTrnCommit(e) { e = e || {}; return ajaxPost({ timeout: 8000, processData: false, ajaxContentType: wsContentType, url: app.getWSUrl({ api: 'sqlTrnCommit', args: e }) }) }
	sqlTrnRollback(e) { e = e || {}; return ajaxPost({ timeout: 8000, processData: false, ajaxContentType: wsContentType, url: app.getWSUrl({ api: 'sqlTrnRollback', args: e }) }) }
