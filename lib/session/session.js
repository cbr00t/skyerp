class Session extends CObject {
	...
	async afterLogin(e) { const {user} = this; if (user) { this.encUser = await app.xenc(user); await this.rolleriYukle(e) } }
	async rolleriYukle(e) { const liste = []; /*debugger;*/ this.roller = liste; return this }
