class Session extends CObject {
	...
	constructor(e) {
		...
		this.roller = e.roller ?? { adimsal: {}, iceriksel: {} }
	}
	...
	async rolleriYukle(e) {
		const result = { adimsal: [], iceriksel: [] }; let _result = await Rol.oku(e), {tip2Belirtec2DetListe} = _result || {};
		if (_result) { $.extend(result, tip2Belirtec2DetListe) } this.roller = result; return this
	}
