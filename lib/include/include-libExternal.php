...
<script src="<?=$_partRoot?>/etc/md5.min.js"></script> <script src="<?=$_partRoot?>/etc/string.js"></script>
<!--<script src="<?=$_partRoot?>/etc/dompurify.min.js"></script> <script src="<?=$_partRoot?>/etc/canvg.js"></script>
<script src="<?=$_partRoot?>/etc/html2canvas.min.js"></script> <script src="<?=$_partRoot?>/etc/jspdf.umd.min.js"></script>-->
