...
class Ortak {
	...
	static async registerSW() {  if ('serviceWorker' in navigator) { try { await navigator.serviceWorker.register(`${webRoot}/sw.php`) } catch (e) { console.error('ServiceWorker registration failed') } } }
}
