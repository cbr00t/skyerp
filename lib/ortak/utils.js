...
function makeScrollable(target) {
	...
	const mouseUpHandler = event => {
		// target.style.cursor = 'grab';
		target.style.cursor = target.style._cursor; delete target.style._cursor; target.style.removeProperty('user-select');
		window.removeEventListener('mousemove', mouseMoveHandler); window.removeEventListener('mouseup', mouseUpHandler);
