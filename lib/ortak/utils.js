...
function promise(proc, result) {
	return result === undefined
		? new Promise(proc)
		: Promise.resolve(result)
}
function defer(proc) { return new $.Deferred(proc) }
function promiseAll(promises) { return Promise.all(promises) }
function promiseAllSet(promises) { return Promise.allSettled(promises) }
function promiseAny(promises) { return Promise.any(promises) }
function promiseRace(promises) { return Promise.race(promises) }
