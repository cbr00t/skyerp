...
function classifyValue(value) {
	if (value == null)                 // undefined == null kabulü ile, tanımsız say ikisini de
		return null
	// ES6 class tespiti
	if (typeof value == 'function' && /^class\s/.test(safeToString(value)))
		return 'class'
	// instance/class tespiti
	if (typeof value == 'object') {
	    let {constructor: ctor} = value
	    if (typeof ctor == 'function' && /^class\s/.test(safeToString(ctor)))
			return 'instance'
		if (isDate(value))
			return 'date'
	}
...
function isArray(value) { return value && Array.isArray(value) }
