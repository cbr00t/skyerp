...
function notify(e = {}, _text, _status, _autotimeout, _autoclose) {
	if (typeof e != 'object') {
		e = {
			title: e, text: _text, status: _status,
			autotimeout: _autotimeout, autoclose: _autoclose
		}
	}
	e.status ||= 'success'; e.autoclose ??= true; e.autotimeout ??= 5000
	let args = {
	    title: '', text: ' ',
