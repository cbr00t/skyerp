...
var encoding_windows = 'windows-1252', encoding_iso = 'ISO-8859-9', encoding_utf8 = 'UTF-8', appActivatedFlag = document?.hasFocus() ?? true;
/*
...
async function requestFullScreen(e) {
	e = e || {};
	if (document.fullscreen || (!e.force && asBool(qs.noFullScreen || qs.tamEkranYok)))
		return true
	...
	try { await document.requestFullscreen(); return true } catch (ex) { }
	try { await document.webkitRequestFullScreen(); return true } catch (ex) { }
	try { await document.mozRequestFullScreen(); return true } catch (ex) { }
	try { await document.msRequestFullscreen(); return true } catch (ex) { }
	return false
}
async function cancelFullScreen(e) {
	...
	try { await document.exitFullscreen(); return true } catch (ex) { }
	try { await document.webkitCancelFullScreen(); return true } catch (ex) { }
	try { await document.mozExitFullScreen(); return true } catch (ex) { }
	try { await document.mozCancelFullScreen(); return true } catch (ex) { }
	try { await document.msExitFullscreen(); return true } catch (ex) { }
	try { await document.msCancelFullscreen(); return true } catch (ex) { }
	return false
}
