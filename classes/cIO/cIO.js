class CIO extends CObject {
	...
	static get pTanim() {
		const {classKey} = this; let result = this._cls2PTanim[classKey];
		if (!result) {
	...
	static pTanimDuzenle(e) { } static pTanimDuzenleSonrasi(e) { } static pTanimDuzenleSonIslemler(e) { }
	...
	pTanim2Inst(e) {
		...
		this.pTanim2InstSonrasi(e) /* Object.freeze(p); */
	}
	...
	shallowCopy(e) {
		...
		if (_p) { inst._p = {}; for (const ioAttr in _p) { const _pInst = _p[ioAttr], pInst = _pInst ? _pInst.shallowCopy(e) : _pInst; inst._p[ioAttr] = pInst } }
		return inst
	}
	deepCopy(e) {
