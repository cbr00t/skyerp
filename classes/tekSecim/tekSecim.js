class TekSecim extends CIO {
	...
	initProps(e) {
		const kaListe = this._kaListe; for (const ka of  kaListe) {
			const {kod, question} = ka; if (!question) { continue }
			Object.defineProperty(this, question, { configurable: true, get() { return this.char == kod } });
