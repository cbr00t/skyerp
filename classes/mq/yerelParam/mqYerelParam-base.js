class MQYerelParamBase extends CIO {
	...
	static get paramKod() { return null } static get sinifAdi() { return 'Yerel Parametreler' } static get tanimUISinif() { return null }
	...
	async kaydet(e) {
		e = $.extend({}, e || {}); this.kaydetOncesi(e); let rec = this.hostVars(e); if (!rec) { return this }
