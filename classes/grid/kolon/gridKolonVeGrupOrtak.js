class GridKolonVeGrupOrtak extends CObject {
	...
	static get deepCopyAlinmayacaklar() { return [...super.deepCopyAlinmayacaklar || [], 'gridPart'] }
	get builder() { return this._builder || this.gridPart?.builder }
	get kodBelirtec() { return this.belirtec } get adiBelirtec() { return null }
	get belirtec() { return getFuncValue.call(this, this._belirtec, { sender: this.sender, colDef: this }) }
	set belirtec(value) { this._belirtec = value }
	readOnly() { this.isEditable = false; return this }
	editable() { this.isEditable = true; return this }
	get isReadOnly() { return !this.isEditable }
	
	constructor(e) { super(e); e = e || {}; this._builder = e.builder; this.readFrom(e) }
	static getClass(e) {
		let cls = GridKolon; if (e) { const {anaTip} = e; if (anaTip) cls = this._anaTip2Sinif[anaTip] || cls }
		return cls
	}
	static from(e) {
		if (!e) return null
	...
	readFrom_ilk(e) {
		...
		const _kodZorunlumu = e.kodZorunlumu || e.kodZorunlu || e.zorunlumu || e.zorunlu;
		this.kodZorunlumu = _kodZorunlumu == null ? this.class.defaultKodZorunlumu : _kodZorunlumu;
	...
	get jqxColumns() { const e = { columns: [] }; this.jqxColumnsDuzenle(e); return e.columns }
	jqxColumnsDuzenle(e) { }
	kodZorunlu() { this.kodZorunlumu = true; return this }
	zorunlu() { this.kodZorunlu(); return this }
	kodZorunluOlmasin() { this.kodZorunlumu = false; return this }
	zorunluDegil() { return this.kodZorunluOlmasin() }
