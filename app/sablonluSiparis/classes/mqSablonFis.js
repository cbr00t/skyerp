class MQSablonOrtak extends MQDetayliVeAdi {
	static { window[this.name] = this; this._key2Class[this.name] = this } static get fisSinif() { return SablonluSiparisListeOrtakFis }
...
class MQSablon extends MQSablonOrtak { static { window[this.name] = this; this._key2Class[this.name] = this } static get fisSinif() { return SablonluSiparisListeFis } }
class MQKonsinyeSablon extends MQSablonOrtak { static { window[this.name] = this; this._key2Class[this.name] = this } static get fisSinif() { return SablonluKonsinyeSiparisListeFis } }
