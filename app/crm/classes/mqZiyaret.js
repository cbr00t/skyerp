class MQZiyaretPlani extends MQSayacliOrtak {
	...
	static pTanimDuzenle(e) {
		super.pTanimDuzenle(e); $.extend(e.pTanim, {
			planTS: new PInstDateTimeNow(), mustKod: new PInstStr('mustkod'), ziyaretciKod: new PInstStr('ziyaretcikod'),
...
class MQZiyaret extends MQSayacliOrtak {
	...
	static pTanimDuzenle(e) {
		super.pTanimDuzenle(e); $.extend(e.pTanim, {
			planSayac: new PInstNum('plansayac'), ts: new PInstDateTimeNow('ziyaretzamani'), mustKod: new PInstStr('mustkod'), ziyaretciKod: new PInstStr('ziyaretcikod'),
