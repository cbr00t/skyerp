...
?>
<script src="<?=$webRoot?>/classes/offline/localData.js?<?=$appVersion?>"></script> <?php require_once("./classes/include.php") ?>
<script src="<?=$webRoot?>/lib_external/etc/quill.js?<?=$appVersion?>"></script> <link async="false" rel="stylesheet" href="<?=$webRoot?>/lib_external/etc/quill.snow.css?<?=$appVersion?>"/>
