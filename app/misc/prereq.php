<?php
	require_once("$webRoot_ticari/include.php"); /*require_once("$webRoot_ticari/include/ortak-01.php");
	require_once("$webRoot_ticari/include/ortak-02.php"); require_once("$webRoot_ticari/classes/mq-param/include.php");
