class ESEApp extends App {
    static { window[this.name] = this; this._key2Class[this.name] = this } get autoExecMenuId() { return 'MAIN' } get isLoginRequired() { return true }
	...
	getAnaMenu(e) {
		...
		if (isAdmin) {
			let classes = [MQUlke, MQIl, MQYerlesim, MQKurum, MQOkulTipi, MQHasta, MQDoktor, MQYetki, MQCari];
			...
			classes = [MQSablonCPT, MQSablonESE];
			subItems = classes.map(cls => new FRMenuChoice({ mne: cls.kodListeTipi, text: cls.sinifAdi, block: e => cls.listeEkraniAc(e) }));
