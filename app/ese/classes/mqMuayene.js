class MQMuayene extends MQGuidOrtak {
	...
	static pTanimDuzenle(e) {
		super.pTanimDuzenle(e); $.extend(e.pTanim, {
			...
			cptPuani: new PInstNum('cptpuani'), esePuani: new PInstBitBool('esepuani'), testSifre: new PInstStr('testsifre'), tani: new PInstStr('tani')
		})
	}
	static orjBaslikListesiDuzenle(e) {
		super.orjBaslikListesiDuzenle(e); e.liste.push(
			new GridKolon({ belirtec: 'hastaid', text: 'Hasta ID', genislikCh: 40 }), new GridKolon({ belirtec: 'hastaadi', text: 'Hasta Adı', genislikCh: 30 }),
	...
	static loadServerData_queryDuzenle(e) {
		...
		sent.sahalar.add(`${alias}.hastaid`)
	}
	static rootFormBuilderDuzenle(e) {
		super.rootFormBuilderDuzenle(e); this.formBuilder_addTabPanelWithGenelTab(e); const {tabPage_genel} = e;
		let form = tabPage_genel.addFormWithParent().yanYana(2); form.addModelKullan('hastaId', 'Hasta').comboBox().kodsuz().setMFSinif(MQHasta);
