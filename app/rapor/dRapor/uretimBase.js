...
class DRapor_Uretim_Main extends DRapor_Donemsel_Main {
	...
	loadServerData_queryDuzenle_ek(e) {
		let {stm, attrSet, alias} = e; for (let sent of stm.getSentListe()) {
			let {sahalar, where: wh} = sent; $.extend(e, { sent }); this.loadServerData_queryDuzenle_uretimOrtakBagla({ ...e, sent });
			if (attrSet.PER) { this.loadServerData_queryDuzenle_gerDetayBagla({ ...e, sent }) } if (attrSet.STOK) { this.loadServerData_queryDuzenle_formulBagla({ ...e, sent }) }
