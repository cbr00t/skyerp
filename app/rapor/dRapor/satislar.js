class DRapor_Satislar extends DRapor_Ticari {
	...
	static get kod() { return 'SATIS' } static get aciklama() { return 'Satışlar' } static get vioAdim() { return 'SA-RCF' }
}
...
class DRapor_Alimlar extends DRapor_Ticari {
	static { window[this.name] = this; this._key2Class[this.name] = this }
	static get kod() { return 'ALIM' } static get aciklama() { return 'Alımlar' } static get vioAdim() { return 'AL-RCF' }
}
...
class DRapor_SatisSiparisler extends DRapor_Ticari {
	static { window[this.name] = this; this._key2Class[this.name] = this }
	static get kod() { return 'SAT_SIP' } static get aciklama() { return 'Satış Siparişler' } static get vioAdim() { return 'SA-RST' }
}
