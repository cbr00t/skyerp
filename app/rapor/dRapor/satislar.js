class DRapor_Satislar extends DRapor_Ticari {
	static { window[this.name] = this; this._key2Class[this.name] = this } static get kategoriKod() { return 'TICARI' }
...
class DRapor_Alimlar extends DRapor_Ticari {
	static { window[this.name] = this; this._key2Class[this.name] = this } static get kategoriKod() { return 'TICARI' }
	static get kod() { return 'ALIM' } static get aciklama() { return 'Alımlar' } }
...
class DRapor_SatisSiparisler extends DRapor_Ticari {
	static { window[this.name] = this; this._key2Class[this.name] = this } static get kategoriKod() { return 'TICARI' }
	static get kod() { return 'SAT_SIP' } static get aciklama() { return 'Satış Siparişler' } }
