class DRapor_StokSatislar extends DRapor_TicariStok {
	...
	static get kod() { return 'STOK_SATIS' } static get aciklama() { return 'Satışlar' } static get vioAdim() { return 'SA-RCF' }
}
class DRapor_StokAlimlar extends DRapor_TicariStok {
	...
	static get kod() { return 'STOK_ALIM' } static get aciklama() { return 'Alımlar' } static get vioAdim() { return 'AL-RCF' }
}
class DRapor_StokSatisSiparisler extends DRapor_TicariStok {
	...
	static get kod() { return 'STOK_SAT_SIP' } static get aciklama() { return 'Satış Siparişler' } static get vioAdim() { return 'SA-RST' }
}
class DRapor_HizmetSatislar extends DRapor_TicariHizmet {
	...
	static get kod() { return 'HIZMET_SATIS' } static get aciklama() { return 'Satışlar' } static get vioAdim() { return DRapor_StokSatislar.vioAdim }
}
class DRapor_HizmetAlimlar extends DRapor_TicariHizmet {
	...
	static get kod() { return 'HIZMET_ALIM' } static get aciklama() { return 'Alımlar' } static get vioAdim() { return DRapor_StokAlimlar.vioAdim }
}
class DRapor_HizmetSatisSiparisler extends DRapor_TicariHizmet {
	...
	static get kod() { return 'HIZMET_SAT_SIP' } static get aciklama() { return 'Satış Siparişler' } static get vioAdim() { return DRapor_StokSatisSiparisler.vioAdim }
}
