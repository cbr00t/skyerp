class DRapor_StokAlimlar extends DRapor_TicariStok {
	...
	static get kod() { return 'STALIM' } static get aciklama() { return 'ESKİ Alımlar (<span class=royalblue>Stok</span>)' }
}
...
class DRapor_HizmetAlimlar extends DRapor_TicariHizmet {
	...
	static get kod() { return 'HZALIM' } static get aciklama() { return 'ESKİ Alımlar (<span class=orangered>Hizmet</span>)' }
}
