<?php $_partRoot = "$webRoot_ticari/classes/ortak/hareketci/classes"?>
<script src="<?=$_partRoot?>/alimSatisOrtak.js?<?=$appVersion?>"></script> <script src="<?=$_partRoot?>/siparis.js?<?=$appVersion?>"></script>
<script src="<?=$_partRoot?>/cari.js?<?=$appVersion?>"></script> <script src="<?=$_partRoot?>/kasa.js?<?=$appVersion?>"></script>
<script src="<?=$_partRoot?>/bankaOrtak.js?<?=$appVersion?>"></script> <script src="<?=$_partRoot?>/bankaMevduatVeKredi.js?<?=$appVersion?>"></script>
<script src="<?=$_partRoot?>/posKr.js?<?=$appVersion?>"></script> <script src="<?=$_partRoot?>/krediTaksit.js?<?=$appVersion?>"></script>
<script src="<?=$_partRoot?>/bankaYatirim.js?<?=$appVersion?>"></script> <script src="<?=$_partRoot?>/bankaYatirimKalan.js?<?=$appVersion?>"></script> 
...
<script src="<?=$_partRoot?>/demirbas.js?<?=$appVersion?>"></script>
