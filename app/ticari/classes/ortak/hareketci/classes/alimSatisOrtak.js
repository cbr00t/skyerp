class AlimSatisOrtakHareketci extends Hareketci {
	...
	static get almSat() { return null } /*static get uygunmu() { return !!config.dev }*/ static get aciklama() { return 'Ticari' }
...
class AlimHareketci extends AlimSatisOrtakHareketci {
	...
	static get kisaKod() { return 'SA' } static get aciklama() { return 'Alım' }
	static get almSat() { return 'A' } 
}
class SatisHareketci extends AlimSatisOrtakHareketci {
    static { window[this.name] = this; this._key2Class[this.name] = this }
	static get kisaKod() { return 'ST' } static get aciklama() { return 'Satış' }
