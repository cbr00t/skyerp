<?php
	...
	require_once("$webRoot/ortak/gridKolonDuzenle/include.php"); require_once("$webRoot/ortak/mq/masterListe/include.php"); require_once("$webRoot/ortak/mq/modelKullan/include.php");
