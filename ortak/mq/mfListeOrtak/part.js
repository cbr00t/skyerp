class MFListeOrtakPart extends GridliGostericiWindowPart {
	...
	destroyPart(e) {
		...
		super.destroyPart(e); const {secimlerPart} = this; if (secimlerPart) { secimlerPart.destroyPart() }
	}
	activated(e) {
	...
	async yeniIstendi(e) {
		...
		const {tanimOncesiEkIslemler, gridWidget} = this, {args} = e, {ozelTanimIslemi} = mfSinif; let inst;
